...
int nest_py_wrapper::testNEST(int argc, char** argv, int print_result,
  ...
  // Instantiate your own VDetector class here, then load into NEST class constructor
	...
	vector<double> signal1,signal2,signalE, vTable, NuisParam={.8,.8}; //scaling factors, for now just for NR Ly & Qy. But must initialize!
...
BOOST_PYTHON_MODULE(nest_py_interfaceBothm20)
{
