...
public:
	...
	virtual void Initialization() {
		...
		E_gas = 11.15; //field in kV/cm between liquid/gas border and anode
		...
		dtCntr = 505.28; //center of detector for S1 corrections, in usec.
		dt_min = 54.6; //minimum. Top of detector fiducial volume
		dt_max = 818.; //maximum. Bottom of detector fiducial volume

		radius = 728.; //millimeters
		...
		gate = 1453.; //mm. This is where the E-field changes (higher)
	...
	virtual double FitS1 ( double xPos_mm, double yPos_mm, double zPos_mm ) {
		return 0.143239 - 0.00004655902*zPos_mm - 0.00000000631595*pow(zPos_mm, 2.0) + 3.06137E-11*pow(zPos_mm, 3.0) - 1.22646E-14*pow(zPos_mm, 4.0);
	}
